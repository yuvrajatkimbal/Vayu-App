...
import { Breakpoints, Theme as MuiTheme } from '@mui/material/styles';
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Typography variant="h6">Changes Confirmation</Typography>
          <IconButton
            aria-label="close"
            onClick={() => {
        ...
        <DialogContent dividers>
          <Typography sx={{ paddingY: '25px' }} gutterBottom>
            {description}
          </Typography>
        </DialogContent>
        <DialogActions>
