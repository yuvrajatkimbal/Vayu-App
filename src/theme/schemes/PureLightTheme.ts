...
const themeColors = {
  ...
  nmsPrimary: '#DBEEFF',
  primaryAlt: '#D1EEFA',
  nmsPrimaryAlt: '#1773BE',
  secondary: '#D7FAE0',
  nmsSecondary: '#D7FAE0',
  secondaryAlt: '#82FF88',
  nmsSecondaryAlt: '#FFDBD8',
  success: '#57CA22',
  warning: '#FFA319',
  error: '#E63D46',
  info: '#33C2FF',
...
const colors = {
  ...
  alpha: {
    ...
    danger: {
      5: alpha(themeColors.error, 0.02),
      10: alpha(themeColors.error, 0.1),
      30: alpha(themeColors.error, 0.3),
      50: alpha(themeColors.error, 0.5),
      70: alpha(themeColors.error, 0.7),
      100: themeColors.error
    },
    primary: {
    ...
    nmsPrimary: {
      5: alpha(themeColors.nmsPrimary, 0.02),
      10: alpha(themeColors.nmsPrimary, 0.1),
      30: alpha(themeColors.nmsPrimary, 0.3),
      50: alpha(themeColors.nmsPrimary, 0.5),
      70: alpha(themeColors.nmsPrimary, 0.7),
      100: themeColors.nmsPrimary
    },
    nmsPrimaryAlt: {
      5: alpha(themeColors.nmsPrimaryAlt, 0.02),
      10: alpha(themeColors.nmsPrimaryAlt, 0.1),
      30: alpha(themeColors.nmsPrimaryAlt, 0.3),
      50: alpha(themeColors.nmsPrimaryAlt, 0.5),
      70: alpha(themeColors.nmsPrimaryAlt, 0.7),
      100: themeColors.nmsPrimaryAlt
    },
    nmsSecondary: {
      5: alpha(themeColors.nmsSecondary, 0.02),
      10: alpha(themeColors.nmsSecondary, 0.1),
      30: alpha(themeColors.nmsSecondary, 0.3),
      50: alpha(themeColors.nmsSecondary, 0.5),
      70: alpha(themeColors.nmsSecondary, 0.7),
      100: themeColors.nmsSecondary
    },
    nmsSecondaryAlt: {
      5: alpha(themeColors.nmsSecondaryAlt, 0.02),
      10: alpha(themeColors.nmsSecondaryAlt, 0.1),
      30: alpha(themeColors.nmsSecondaryAlt, 0.3),
      50: alpha(themeColors.nmsSecondaryAlt, 0.5),
      70: alpha(themeColors.nmsSecondaryAlt, 0.7),
      100: themeColors.nmsSecondaryAlt
    },
  },
  secondary: {
  ...
  grey: {
    lighter: lighten(themeColors.grey, 0.85),
    light: lighten(themeColors.grey, 0),
    main: themeColors.grey,
    dark: darken(themeColors.grey, 1)
  },
  borderColor: {
    lighter: lighten(themeColors.borderColor, 0.85),
    light: lighten(themeColors.borderColor, 0.3),
    main: themeColors.borderColor,
    dark: darken(themeColors.borderColor, 1)
  },
  tableBackground: {
    lighter: lighten(themeColors.tableBackground, 0.85),
    light: lighten(themeColors.tableBackground, 0.75),
    main: themeColors.tableBackground,
    dark: darken(themeColors.tableBackground, 1)
  },
  info: {
...
export const PureLightTheme = createTheme({
  ...
  colors: {
    ...
    grey: {
      lighter: alpha(themeColors.grey, 0.1),
      light: lighten(themeColors.grey, 0.3),
      main: themeColors.grey,
      dark: darken(themeColors.grey, 1)
    },
    borderColor: {
  ...
  palette: {
    ...
    action: {
      ...
      selectedOpacity: 0.1,
      disabled: colors.alpha.black[50],
      disabledBackground: colors.alpha.black[100],
      disabledOpacity: 0.8,
    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          ...
          '& .css-jn689n-MuiInputBase-input-MuiOutlinedInput-input': {
            padding: '13.5px',
            borderColor: colors.alpha.black[100]
          },
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...
          '&:hover': {
            backgroundColor: colors.alpha.black[5], // Change this to your desired hover background color
            color: colors.alpha.black[100], // Change this to your desired hover text color
            borderColor: colors.alpha.black[50] // Change this to your desired hover border color if needed
          }
        },
        endIcon: {
          marginRight: -8
    ...
    MuiTablePagination: {
      styleOverrides: {
        root: {
          ...
          '& .css-s6v4jg-MuiSelect-select-MuiInputBase-input.css-s6v4jg-MuiSelect-select-MuiInputBase-input.css-s6v4jg-MuiSelect-select-MuiInputBase-input':
            {
              paddingRight: '36px',
              border: `1px solid ${colors.alpha.black[100]} !important`,
              background: `${colors.primary.main} !important`,
              fontSize: '15px',
              fontWeight: 400
            },
          '& .css-1s0zqx1-MuiInputBase-root-MuiTablePagination-select': {
            marginRight: '10px'
          },
